  ...
  useEffect(() => {
    const fetchStudentReport = async () => {
      try {
        ...
        if (response.data.data.reportGenerated) {
          setStudentData(response.data.data.userReport.studentDetails);
          setMonthlyReports(response.data.data.userReport.monthlyReports || []);
          setQuarterlyReport(response.data.data.userReport);
        }else{
          setError('Your report is yet to be generated by the assigned teacher');
        }
      } catch (err) {
