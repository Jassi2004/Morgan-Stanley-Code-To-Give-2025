...
const Team = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      bodyImage: "/images/suit.png",
      role: 'Developer',
      description: 'My name is Anshul Sharma, a pre-final year student at chitkara University. I am contributing as a backend developer for website',
    },
    {
      name: "Harneet Atwal",
      ...
      bodyImage: "/images/women-suit.png",
      role: 'Developer',
      description: 'My name is Harneet Atwal, a third-year student at Chitkara University. I am contributing as a Data Analyste for the AI chatbot and debugging the website.',
    },
  ];
